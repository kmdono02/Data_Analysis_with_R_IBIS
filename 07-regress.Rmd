...
mixed_effect_data_complete <- data.frame(mixed_effect_data_complete, "predicted_value"=predict(mixed_fit, newdata = mixed_effect_data_complete))
...
mixed_effect_data_complete <- data.frame(mixed_effect_data_complete, "predicted_value"=predict(mixed_fit_interact))
